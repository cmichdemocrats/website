  ...
  return (
    <main id={styles.main}>
      ...
      <section id={styles.actionList}>
        <button onClick={() => location.href = "https://github.com/cmichdemocrats/website/commits/production/src/pages/ConstitutionPage/constitution.md"}>View history</button>
